...
export function buildFinalizerPrompt(
  ...
  const system = [
    ...
    "→ tests), NOT alphabetical. Give each a ONE-sentence \"role\": what the file does in this",
    "change and how it connects to the others. Skip lockfiles/generated files.",
    "",
